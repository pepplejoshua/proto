    ...
    pub fn eval(&mut self) {
        ...
        instructions.iter().enumerate().for_each(|(_, ins)| {
            ...
            match ins.tag {
                ...
                CodeTag::Neq => {
                    // Neq Code:30 Code:31
                    // println!("comparing for inequality");
                    let a_i = ins.indices[0];
                    let b_i = ins.indices[1];
                    ...
                    match (a_ty.tag, b_ty.tag) {
                        ...
                        (TSTag::Bool, TSTag::Bool)
                        | (TSTag::Char, TSTag::Char)
                        | (TSTag::Str, TSTag::Str)
                        | (TSTag::Type, TSTag::Type) => {
                            let ty = TypeSignature {
                                tag: TSTag::Bool,
                                src: ins.src.clone(),
                                indices: vec![],
                ...
                CodeTag::Eq => {
                    // Eq Code:30 Code:31
                    // println!("comparing for equality");
                    let a_i = ins.indices[0];
                    let b_i = ins.indices[1];
                ...
                CodeTag::LtEq => {
                    // LtEq Code:30 Code:31
                    // println!("comparing for less than or equal to");
                    let a_i = ins.indices[0];
                    let b_i = ins.indices[1];
                ...
                CodeTag::GtEq => {
                    // GtEq Code:30 Code:31
                    // println!("comparing for greater than or equal to");
                    let a_i = ins.indices[0];
                    let b_i = ins.indices[1];
